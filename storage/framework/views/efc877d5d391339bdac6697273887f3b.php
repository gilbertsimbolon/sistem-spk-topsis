            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form action="<?php echo e(route('data-kost.destroy', $kost->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus seluruh data kost ini?')">
                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalEditKost" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo e(route('data-kost.update', $kost->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
