            ...
            <div class="row g-4">
                <?php $__currentLoopData = $kostsTopsis ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <a href="<?php echo e(route('dashboard.kost.show', $kos->id)); ?>"
                            ...
                            <div class="card border-0 shadow-sm h-100 kost-card">
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div>
                                        <h6 class="fw-bold text-dark text-truncate mb-1" title="<?php echo e($kos->nama_kost); ?>">
                                            <?php echo e($kos->nama_kost); ?></h6>
                                        ...
                                        <p class="text-secondary small text-truncate mb-3"
                                            title="<?php echo e($kos->fasilitas->implode('keterangan', ' • ')); ?>">
                ...
                <div class="card-body p-4">
                    ...
                    <form id="filterForm" action="<?php echo e(route('dashboard.index')); ?>" method="GET">
                        <div class="row g-3 align-items-end">
                                ...
                                <select class="form-select filter-input" name="daerah_kost_id" id="daerahSelect">
                                    ...
                                    <?php $__currentLoopData = $daerah ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>"
                                            <?php echo e(request('daerah_kost_id') == $d->id ? 'selected' : ''); ?>>
                                            <?php echo e($d->name); ?>
                                ...
                                <select class="form-select filter-input" name="tipe_kost">
                                    ...
                                    <?php $__currentLoopData = $jenis ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($j->id); ?>"
                                            <?php echo e(request('tipe_kost') == $j->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="harga_minimal" name="harga_minimal"
                                        ...
                                        value="<?php echo e(request('harga_minimal') ? 'Rp ' . number_format(request('harga_minimal'), 0, ',', '.') : ''); ?>"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="harga_maksimal" name="harga_maksimal"
                                        class="form-control rupiah-field filter-input"
                                        value="<?php echo e(request('harga_maksimal') ? 'Rp ' . number_format(request('harga_maksimal'), 0, ',', '.') : ''); ?>"
                            ...
                            <div class="collapse col-12 <?php echo e(request('fasilitas') || request('keamanan') || request('kebersihan') ? 'show' : ''); ?>"
                                id="collapseKriteria">
                                                ...
                                                <?php $__currentLoopData = $fasilitas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input filter-input" type="checkbox"
                                                            name="fasilitas[]" value="<?php echo e($f->id); ?>"
                                                            id="f-<?php echo e($f->id); ?>"
                                                            <?php echo e(is_array(request('fasilitas')) && in_array($f->id, request('fasilitas')) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="criteria-box shadow-sm">
                                            ...
                                            <div style="max-height: 150px; overflow-y: auto; padding-right: 5px;">
                                                <?php $__currentLoopData = $keamanan ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input filter-input" type="checkbox"
                                                            name="keamanan[]" value="<?php echo e($k->id); ?>"
                                                            id="k-<?php echo e($k->id); ?>"
                                                            <?php echo e(is_array(request('keamanan')) && in_array($k->id, request('keamanan')) ? 'checked' : ''); ?>>
                                                        <label class="form-check-label small text-dark"
                                                            for="k-<?php echo e($k->id); ?>"><?php echo e($k->keterangan); ?></label>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="criteria-box shadow-sm">
                                            ...
                                            <div style="max-height: 150px; overflow-y: auto; padding-right: 5px;">
                                                <?php $__currentLoopData = $kebersihan ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input filter-input" type="checkbox"
                                                            name="kebersihan[]" value="<?php echo e($b->id); ?>"
                                                            id="b-<?php echo e($b->id); ?>"
                                                            <?php echo e(is_array(request('kebersihan')) && in_array($b->id, request('kebersihan')) ? 'checked' : ''); ?>>
                                                        <label class="form-check-label small text-dark"
                                                            for="b-<?php echo e($b->id); ?>"><?php echo e($b->keterangan); ?></label>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div>
                                            <h6 class="fw-bold text-dark text-truncate mb-1"
                                                title="<?php echo e($kos->nama_kost); ?>"><?php echo e($kos->nama_kost); ?></h6>
                                            <small class="text-muted d-block mb-2">
                                                <i
                                                    class="bi bi-geo-alt me-1"></i><?php echo e($kos->daerah->name ?? 'Tidak Ada Daerah'); ?>
