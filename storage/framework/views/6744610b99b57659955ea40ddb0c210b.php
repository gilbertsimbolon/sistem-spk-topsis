                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = $filteredSubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($s->nilai_minimum !== null || $s->nilai_maksimum !== null): ?>
                                                        <span class="badge bg-light text-dark border py-2 px-3 fs-7">
                                                            <?php if($namaKriteriaClean === 'harga'): ?>
                                                                Rp <?php echo e(number_format($s->nilai_minimum, 0, ',', '.')); ?> - Rp <?php echo e(number_format($s->nilai_maksimum, 0, ',', '.')); ?>

                                                            <?php elseif(in_array($namaKriteriaClean, ['fasilitas', 'keamanan', 'kebersihan'])): ?>
                                                                <?php echo e($s->nilai_minimum); ?>% - <?php echo e($s->nilai_maksimum); ?>%
                                                            <?php elseif($namaKriteriaClean === 'jarak'): ?>
                                                                <?php echo e(number_format($s->nilai_minimum, 0, ',', '.')); ?> m - <?php echo e(number_format($s->nilai_maksimum, 0, ',', '.')); ?> m
                                                            <?php else: ?>
                                                                <?php echo e(number_format($s->nilai_minimum, 0, ',', '.')); ?> - <?php echo e(number_format($s->nilai_maksimum, 0, ',', '.')); ?>
                                                ...
                                                <td><span class="badge bg-primary px-3 py-2 fs-6"><?php echo e($s->nilai); ?></span></td>
                                                <td>
                                            ...
                                            <div class="modal fade" id="editSubKriteriaModal<?php echo e($s->id); ?>"
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="<?php echo e(route('sub-kriteria.update', $s->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PUT'); ?>
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Edit Sub Kriteria: <?php echo e($c->nama_kriteria); ?></h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <input type="hidden" name="criteria_id" value="<?php echo e($s->criteria_id); ?>">

                                                                <div class="row mb-3">
                                                                    <div class="col-6">
                                                                        <label class="form-label">
                                                                            Nilai Minimum 
                                                                            <?php if($namaKriteriaClean === 'harga'): ?> (Rp) <?php elseif(in_array($namaKriteriaClean, ['fasilitas', 'keamanan', 'kebersihan'])): ?> (%) <?php elseif($namaKriteriaClean === 'jarak'): ?> (m) <?php endif; ?>
                                                                        </label>
                                                                        <input type="number" name="nilai_minimum" class="form-control" value="<?php echo e($s->nilai_minimum); ?>" required>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label class="form-label">
                                                                            Nilai Maksimum 
                                                                        ...
                                                                        <input type="number" name="nilai_maksimum" class="form-control" value="<?php echo e($s->nilai_maksimum); ?>" required>
                                                                    </div>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label class="form-label">Keterangan Sub Kriteria</label>
                                                                    <input type="text" name="keterangan" class="form-control" value="<?php echo e($s->keterangan); ?>" required>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label class="form-label">Nilai / Bobot Sub</label>
                                                                    <input type="number" name="nilai" class="form-control" value="<?php echo e($s->nilai); ?>" min="1" max="5" required>
                                                                </div>
                                                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="criteria_id" id="selectKriteriaUtama" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>" data-nama="<?php echo e(strtolower(trim($c->nama_kriteria))); ?>"><?php echo e($c->nama_kriteria); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
