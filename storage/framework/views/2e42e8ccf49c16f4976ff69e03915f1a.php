...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-3">
        ...
        <a href="<?php echo e(route('owner.kost.index')); ?>" class="btn btn-secondary btn-sm"><i class="bx bx-arrow-back"></i> Kembali</a>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <button class="btn btn-warning btn-sm fw-semibold" data-bs-toggle="modal"
                                data-bs-target="#modalEditKost">
                                <i class="bx bx-edit-alt"></i> Edit Kost
                            </button>

                            <form action="<?php echo e(route('owner.kost.destroy', $kost->id)); ?>" method="POST"
                                onsubmit="return confirm('Yakin ingin menghapus seluruh data kost ini?')">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="carousel-inner rounded overflow-hidden">
                                <?php $__currentLoopData = $kost->foto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                                        <img src="<?php echo e(asset('storage/' . $foto->foto)); ?>" class="d-block w-100"
                            ...
                            <?php $__currentLoopData = $kost->foto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="position-relative d-inline-block">
                                    <button type="button" data-bs-target="#kostCarousel"
                                        data-bs-slide-to="<?php echo e($key); ?>" class="border-0 bg-transparent p-0">
                                        <img src="<?php echo e(asset('storage/' . $foto->foto)); ?>" class="rounded border shadow-sm"
                                            style="width:120px;height:90px;object-fit:cover;cursor:pointer;">
                                    </button>

                                    
                                    <form action="<?php echo e(route('owner.kost-foto.destroy', $foto->id)); ?>" method="POST"
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(asset('template/paneladmin/assets/img/background/1.jpg')); ?>" class="img-fluid rounded"
        ...
        <div class="col-md-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('owner.kost-foto.store', $kost->id)); ?>" method="POST"
    ...
    <div class="modal fade" id="modalEditKost" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('owner.kost.update', $kost->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kost" value="<?php echo e($kost->nama_kost); ?>" class="form-control"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga" value="<?php echo e($kost->harga); ?>" class="form-control"
                                required>
                        </div>
                            ...
                            <select name="jenis_kost_id" class="form-select" required>
                                <?php $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($j->id); ?>"
                                        <?php echo e($kost->jenis_kost_id == $j->id ? 'selected' : ''); ?>>
                            ...
                            <select name="daerah_kost_id" class="form-select" required>
                                <?php $__currentLoopData = $daerah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($d->id); ?>"
                                        <?php echo e($kost->daerah_kost_id == $d->id ? 'selected' : ''); ?>>
                                        <?php echo e($d->name); ?>
                            ...
                            <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-check-inline me-3">
                                    <input class="form-check-input" type="checkbox" name="fasilitas[]"
                                        value="<?php echo e($f->id); ?>" id="f-<?php echo e($f->id); ?>"
                                        <?php echo e($kost->fasilitas->contains($f->id) ? 'checked' : ''); ?>>
                                    <label class="form-check-label"
                                        for="f-<?php echo e($f->id); ?>"><?php echo e($f->keterangan); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                            ...
                            <?php $__currentLoopData = $keamanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-check-inline me-3">
                                    <input class="form-check-input" type="checkbox" name="keamanan[]"
                                        value="<?php echo e($dk->id); ?>" id="k-<?php echo e($dk->id); ?>"
                                        <?php echo e($kost->keamanan->contains($dk->id) ? 'checked' : ''); ?>>
                                    <label class="form-check-label"
                                        for="k-<?php echo e($dk->id); ?>"><?php echo e($dk->keterangan); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php $__currentLoopData = $kebersihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-check-inline me-3">
                                    <input class="form-check-input" type="checkbox" name="kebersihan[]"
                                        value="<?php echo e($kb->id); ?>" id="kb-<?php echo e($kb->id); ?>"
                                        <?php echo e($kost->kebersihan->contains($kb->id) ? 'checked' : ''); ?>>
                                    <label class="form-check-label"
                                        for="kb-<?php echo e($kb->id); ?>"><?php echo e($kb->keterangan); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
