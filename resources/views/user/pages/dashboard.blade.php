                                        ...
                                        <div class="criteria-box">
                                            ...
                                            <div class="row row-cols-2 g-2">
                                                @foreach($keamanan ?? [] as $k)
                                                    <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="keamanan[]" value="{{ $k->id }}" id="k-{{ $k->id }}"><label class="form-check-label small" for="k-{{ $k->id }}">{{ $k->keterangan }}</label></div></div>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="criteria-box">
                                    ...
                                    <div class="row row-cols-2 g-2">
                                        @foreach($kebersihan ?? [] as $b)
                                            <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="kebersihan[]" value="{{ $b->id }}" id="b-{{ $b->id }}"><label class="form-check-label small" for="b-{{ $b->id }}">{{ $b->keterangan }}</label></div></div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="criteria-box">
                                    ...
                                    <div class="row row-cols-2 g-2">
                                        @foreach($fasilitas ?? [] as $f)
                                            <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="fasilitas[]" value="{{ $f->id }}" id="f-{{ $f->id }}"><label class="form-check-label small" for="f-{{ $f->id }}">{{ $f->keterangan }}</label></div></div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
