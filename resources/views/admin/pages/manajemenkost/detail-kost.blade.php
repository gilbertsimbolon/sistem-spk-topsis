            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form action="{{ route('data-kost.destroy', $kost->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus seluruh data kost ini?')">
                            @csrf
                            @method('DELETE')
...
{{-- MODAL EDIT KOST (Diletakkan di luar row utama agar render modal sempurna) --}}
<div class="modal fade" id="modalEditKost" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('data-kost.update', $kost->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
<script>
    function handleNewFotoDetail(input) {
        const previewContainer = document.getElementById('preview-foto-detail');
