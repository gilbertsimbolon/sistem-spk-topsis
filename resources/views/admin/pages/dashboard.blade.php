                ...
                <div class="d-flex align-items-start row">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-6">
                            <img src="{{ asset('template/paneladmin/assets/img/illustrations/man-with-laptop.png') }}" height="175"
                                alt="View Badge User" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('template/paneladmin/assets/img/icons/unicons/cc-users.png') }}"
                            ...
                            <h4 class="card-title mb-3">2000+ Orang</h4>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-6">
                    <div class="card h-60">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('template/paneladmin/assets/img/icons/unicons/cc-house.png') }}" alt="kost"
                                        class="rounded" />
                                </div>
                                <div class="dropdown">
